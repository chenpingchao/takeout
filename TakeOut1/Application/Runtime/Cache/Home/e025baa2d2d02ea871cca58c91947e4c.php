        ...
        <form action="" method="post" id="pwdchange">
            <div class="main">
                <table width="100%" border="0" cellspacing="0" class="main1">
                    <tr>
                        <td class="text">
                            <input type="password" name="password" id="password" class="text1" placeholder="输入新密码"/>
            ...
            <div class="button"><input type="submit" value="找回密码" class="text2" id="submit" /></div>
        </form>
                    ...
                    if (data) {
                        for (var i in data) {
                            ...
                            if(i==='username'){
                                ...
                                $('.repwd').text(data.repwd).addClass('error')
                            }
