...
<body>
    ...
    <div id="replace">
        ...
        <div class="indexmain">
            ...
            <tr>
                <?php if(is_array($menu)): $k = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "$empty_menu" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><td class="main_1" >
    ...
    <table width="100%" border="0" cellspacing="0" class="nav">
    	<tr>
            ...
            <td width="25" class="foot"><a href="../../../../index.php"><img src="/public/img/22.png" width="30%" height="auto"/><p>分类</p></a></td>
            <td width="25" class="foot"><a href="../../../../index.php"><img src="/public/img/33.png" width="30%" height="auto"/><p>购物车</p></a></td>
