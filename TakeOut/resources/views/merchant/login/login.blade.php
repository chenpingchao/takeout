...
<body id="login_bg">
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
        	<form id="loginForm" action="" method="post">{{--提交给自己--}}
				{{csrf_field()}}
...
{{--			    <label class="fl" for="remember"><input type="checkbox" id="remember" value="" checked="checked" name="autoLogin" /> 记住我</label>--}}
			    <a href="{{route('merchant.misspwd')}}" class="fr" target="_blank">忘记密码？</a>
			    
				<!--<input type="submit" id="submitLogin" value="登 &nbsp; &nbsp; 录" />-->
				<a style="color:#fff;" href="{{route('merchant.login')}}" class="submitLogin" target="_self" title="登 &nbsp; &nbsp; 录"/>登 &nbsp; &nbsp; 录</a>
			...
			<div class="login_right">
				<a  href="{{route('merchant.register')}}"  class="registor_now">立即注册</a>
			  </div>
        </div>
...
function geetest(){
	$.ajax({
		url: "{{route('merchant.geetest')}}" + "/"+Math.random(), // 加随机数防止缓存
		type: "get",
		dataType: "json",
