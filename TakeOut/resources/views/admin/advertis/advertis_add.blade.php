            ...
            <form action="" method="post">
                ...
                <ul class="forminfo">
                    <li>
                        ...
                        <input name="advertisP_name" type="text" value="{{old('advertisP_name')}}" class="dfinput" placeholder="请填写广告位名称"  style="width:518px;"/>
                        <div class="validate-error">{{$errors->first('advertisP_name')}}</div>
                    </li>
                    <li>
                        <label>广告数量<b>*</b></label>
                        <input name="advertis_num" type="text" value="{{old('advertis_num')}}" class="dfinput" placeholder="请填写广告数量"  style="width:518px;"/>
                        <div class="validate-error">{{$errors->first('advertis_num')}}</div>
                    </li>
                    <li>
                        <label>广告图宽度<b>*</b></label>
                        <input name="width" type="text"  value="{{old('width')}}" class="dfinput" placeholder="请填写广告图宽度"  style="width:518px;"/>
                        <div class="validate-error">{{$errors->first('width')}}</div>
                    </li>
                    <li>
                        <label>广告图高度<b>*</b></label>
                        <input name="height" type="text"  value="{{old('height')}}" class="dfinput" placeholder="请填写广告图高度"  style="width:518px;"/>
                        <div class="validate-error">{{$errors->first('height')}}</div>
                    </li>
                    <li>
                        <label>广告位描述<b>*</b></label>
                        <textarea name="description" id="" cols="30" rows="10" placeholder="请填写广告位描述信息" style="border:1px solid #ccc;width:518px;height:6em;">{{old('description')}}</textarea>
