			...
			<ul class="nav ace-nav">
				<li class="light-blue">
					...
					<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li><a href="{{route('bg.admin.info')}}" target="iframe" name="admin_info.html" title="个人信息" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
						<li class="divider"></li>
	...
	<div class="main-container-inner">
		...
		{{--	<div class="sidebar-shortcuts" id="sidebar-shortcuts">
			...
			<div id="menu_style" class="menu_style">
				{{--left--}}
				<iframe src="{{route('bg.left')}}" name="left" frameborder="0" width="189" height="100%" scrolling="no"></iframe>
				{{--left--}}
			</div>
			<script type="text/javascript">
		...
		<div class="main-content">
			...
			<iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="{{route("bg.main")}}">  </iframe>
			<!-- /.page-content -->
		</div><!-- /.main-content -->
...
{{--底部开始--}}
<iframe id="bottom" src="{{route('bg.footer')}}" name="footer" frameborder="0" width="100%" height="31" scrolling="no"></iframe>
{{--底部结束--}}
<!--修改密码样式-->
...
<script>
	...
	function logout(){
		layer.confirm('真的要退出吗?' , {title:'退出提示' , icon:3 , 'btn':['确认','取消'] }, function(){
			//异步提交退出请求
			$.get("{{route('bg.Logout')}}","",function(data){
				if(data.status == 'ok'){
