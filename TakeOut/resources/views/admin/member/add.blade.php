...
<ul>
    <form action="" method="post">
        ...
        <li>
            ...
            <input type="text" id="grade_name" name="grade_name" style="line-height: 2em;text-indent: 5px">
        ...
        <li>
            ...
            <input type="text" id="score" name="score" style="line-height: 2em">
            <div class="validate-error score" style="background: url('/image/error.png') no-repeat 5px 10px;"></div>
        </li>
        <li>
            <label>详细福利:<b></b></label>
            <textarea name="detail" id="content" style="width: 420px" rows="20"></textarea>
        </li>
        <li>
