    ...
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="" method="post">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{$permission->id or 0}}"/>
                <ul class="forminfo">
                    <li>
                    ...
                    <li>
                        ...
                        <input name="name" type="text"  value="{{$permission->name}}" class="dfinput" style="width:408px;"/>

                    </li>
                    <li>
                        <label>权限显示名称<b>*</b></label>
                        <input name="display_name" type="text"  value="{{$permission->display_name}}" class="dfinput" style="width:408px;"/>
                    </li>
