        ...
        <div id="scrollsidebar" class="left_Treeview" >
            ...
            <!--文章列表-->
                ...
                <div class="border clearfix" >
                    <span class="l_f">
                        <a href="{{route('bg.article.add')}}"  title="添加文章" id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i> 添加文章</a>
                        <a href="{{route('bg.article.deletes')}}" class="btn article_deletes"><i class="fa fa-trash"></i> 批量删除</a>
                    </span>
                    <span class="r_f">共：<b>{{$article_list_num}}</b>条文章</span>
                </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <td>{{$v -> active == 1 ? '发布':'未发布'}}</td>
                        <td class="td-manage">
                            <a title="编辑" href=""  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                            <a title="删除" href="{{route('bg.article.delete',['id'=>$v -> id])}}"   class="btn article-delete btn-danger" ><i class="fa fa-trash  bigger-120"></i></a>
                        </td>
                    </tr>
                    @empty
                        <td colspan="8">
