...
<div class="margin clearfix">
    <div class="sort_style">
        ...
        <a href="{{route('bg.article.deletes1')}}" class="btn article_deletes1 btn-danger"><i class="fa fa-trash"></i> 批量删除</a>
        </span>
            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <a title="删除" href="{{route('bg.article.delete1',['id'=>$v -> id])}}" class="btn btn-xs article_delete1 btn-danger" ><i class="fa fa-trash  bigger-120"></i></a>
                    </td>
                </tr>
                </tbody>
                @empty
