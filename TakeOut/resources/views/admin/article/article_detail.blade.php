...
<head>
    ...
    <link href="/home/style/style.css" rel="admin/stylesheet" type="text/css" />
...
<header>
    <section class="Topmenubg">
        <div class="Topnav">
            <div class="LeftNav">
                <a href="{{route('home.register')}}">注册</a>/<a href="{{route('home.login')}}">登录</a><a href="#">QQ客服</a><a href="#">微信客服</a><a href="#">手机客户端</a>
            </div>
            <div class="RightNav">
                <a href="{{route('hm.mem.UserCenter')}}">用户中心</a>
                <a href="{{route('hm.mem.UserOrder')}}" target="_blank" title="我的订单">我的订单</a>
                <a href="{{route('home.cart')}}">购物车（0）</a>
    ...
    <div class="Logo_search">
        <div class="Logo">
            <img src="/home/images/logo.jpg" title="DeathGhost" alt="模板">
            <i></i>
    ...
    <nav class="menu_bg">
        <ul class="menu">
            ...
            <li><a href="{{route('hunt_list')}}">订餐</a></li>
            <li><a href="{{route('hm.mem.UserCoupon')}}">积分商城</a></li>
            <li><a href="">关于我们</a></li>
        </ul>
    </nav>
</header>
...
<section class="Psection MT20">
    <article class="A-left Overflow">
        @forelse($article_detail as $k => $v)
        <h1 class="Font16 FontW classtitle">{{$v->title}}</h1>
        <div class="A-read">
            {{$v->content}}
        </div>
            @empty
    ...
    <aside class="A-right Overflow">
        <div class="AAlist">
            ...
            <ul>
                <li><a href="article_read.html" target="_blank" title="这里是推荐某分类文章">这里是推荐某分类文章...</a></li>
            </ul>
        </div>
        <!--广告位-->
        <div style="margin:8px 0;">
            <a href="#" target="_blank"><img src="/home/upload/ggw.jpg"></a>
        </div>
    </aside>
</section>
<!--End content-->
