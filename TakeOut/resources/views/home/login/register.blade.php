        ...
        <table class="Register">
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="error" style="display: block;">{{$errors->first('repwd')}}</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span class="error" style="display: block;">{{$errors->first('mobile')}}</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><button type="button" name="" id="Submit_b" class="Submit_b" style="background-color:#2d6983;height:30px;width:80px;color:#CCCCCC;">注 册</button>( 已经是会员，<a href="{{route('home.login')}}" class="BlueA">请登录</a> )</td>
            </tr>
        </table>
    </form>
</section>
...
<script type="text/javascript">
    ...
    $('.Submit_b').click(function(){   //submit按钮方式提交
        if(myvalidate.form()){ //判断前端验证是否通过
            $.post('{{route("home.register")}}',$('#form1').serialize(),function(data){
                //判断是否注册成功
                if(data.status === 'ok'){
...
//获取短信验证码
    function getMsg(){
        ...
        if(mobileReg.test(mobile)){
            $.post('{{route("home.sendMsg")}}', {mobile:mobile,_token:'{{csrf_token()}}'}, function(msg) {
                // console.log(msg);
                if(msg === '提交成功'){
                    RemainTime();
                }else{
