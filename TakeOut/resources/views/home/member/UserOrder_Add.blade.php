...
<div id="OrderAct5-select-from" class="add_menber">
    <form action="" id="form1" method="post">
        ...
        <table id="add_tab">
            <tr>
                <td align="right" class="FontW">发起评论：</td>
                <td><textarea name="detail" cols="" rows="" maxlength="200" minlength="3"  required placeholder="至少3字最多200字...." style="width: 300px;height:80px"></textarea></td>
            </tr>
            <tr colspan="2">
                <div class="content">
                    <p class="title">评分打星</p>
...
<script>
    ...
    $('.Submit_b').click(function(){   //submit按钮方式提交
        ...
        //写入name为fenshu的文本框
        $('#FG').val(fun);
        // var Fs=document.getElementById("FG").value;
        // alert(Fs);
        $.post('{{route("hm.mem.UserOrder_Add",$id)}}',$('#form1').serialize(),function(data){
            //判断是否成功
            if(data.status === 'ok'){
