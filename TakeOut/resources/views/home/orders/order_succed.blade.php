...
@section('main')
    ...
    <section class="Psection MT20 Textcenter"  id="Aflow">
        ...
        <p class="Font14 Lineheight35 FontW">您的订单编号为：<span class="CorRed">{{$data['orders_num']}}</span></p>
        <p class="Font14 Lineheight35 FontW">共计金额：<span class="CorRed">￥{{$data['orders_price']}}</span></p>
        <p>
            <button type="button" class="Lineheight35"><a href="#" target="_blank">支付宝立即支付</a></button>
            <button type="button" class="Lineheight35"><a href="{{route('hm.mem.UserOrder')}}">进入用户中心</a></button>
        </p>
    </section>
    @else
        <section class="Psection MT20 Textcenter" id="Aflow">
            ...
            <p>
                <button type="button" class="Lineheight35">
                    <a href="{{route('hm.mem.UserOrder')}}">进入用户中心</a>
                </button>
            </p>
        </section>
    @endif
