...
<div class="clearfix">
    <div class="article_style" id="article_style">
        <div class="Ads_list" style="margin-left:0px; ">
            ...
            <div class="search_style">
                <form action="">
                    <ul class="search_content clearfix">
                        <li><label class="l_f">店铺名称:</label><input name="shop_name" value="<?php echo e(old('shop_name')); ?>" type="text" class="text_add" placeholder="店铺名称" style=" width:150px"></li>
                        <li><label class="l_f">持有人姓名:</label><input name="sm_name" value="<?php echo e(old('sm_name')); ?>" type="text" class="text_add" placeholder="持有人姓名" style=" width:150px"></li>
                        <li><label class="l_f">所属分类:</label><input name="sc_name" value="<?php echo e(old('sc_name')); ?>" type="text" class="text_add" placeholder="所属分类" style=" width:200px">
                        <li>
                    ...
                    <ul class="search_content clearfix" style="margin-top: 15px">
                        ...
                        <li><label class="l_f">起始时间</label><input autocomplete="off" class="inline laydate-icon" name="start_time" value="<?php echo e(old('start_time')); ?>" placeholder="起始时间" id="start" style=" margin-left:10px;"></li>
                        <li><label class="l_f">结束时间</label><input autocomplete="off" class="inline laydate-icon" name="end_time" value="<?php echo e(old('end_time')); ?>" placeholder="结束时间" id="end" style=" margin-left:10px;"></li>
            ...
            <div class="border clearfix"><span class="l_f"><a href="<?php echo e(route('bg.shop.deletes')); ?>" class="btn btn-danger shop-deletes"><i class="fa fa-trash"></i> 批量删除</a></span>
                <span class="r_f">共:&nbsp;<b><?php echo e($shop_num); ?></b>&nbsp;家店铺</span>
            </div>
            <div class="article_list" style="width: 1300px">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php switch($v -> active):
                                ...
                                <?php break; ?>
                                <?php case (3): ?>
                            <a href="<?php echo e(route('bg.shop.detail',['id'=>$v->id])); ?>">
                                审核中</a>
                                <?php break; ?>
                                <?php default: ?>
                                禁用
                        ...
                        <td class="td-manage">
                            <a title="禁用" href="<?php echo e(route('bg.shop.stop',['id'=>$v->id,'active'=>$v->active])); ?>" class="btn btn-xs shop-stop btn-success" ><?php echo e($v->active == 4?'激活':'禁用'); ?></a>
                ...
                <div style="margin-top: -17px">
                    <div style="float: left;font-size: 16px;">共<?php echo e(ceil($shop_list->total()/$shop_list->count())); ?>页 当前第<?php echo e($shop_list->currentPage()); ?>页</div>
                    <div style="float: right"><?php echo e($shop_list -> appends(['sc_name' => $sc_name,'active' => $active,'shop_name'=>$shop_name]) -> links()); ?></div>
                </div>
            </div>
        </div>
    </div>
