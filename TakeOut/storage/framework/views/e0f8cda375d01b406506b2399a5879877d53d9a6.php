...
<div id="Guestbook">
    <div class="content_style">
        <div class="form-group">
            ...
            <div class="col-sm-9 username-one"><?php echo e($content[0]['username']); ?></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 留言内容 </label>
            <div class="col-sm-9 content-one"><?php echo e($content[0]['content']); ?></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 回复内容</label>
            <div class="col-sm-9 content-one"><?php echo e($content['reply'] ? $content['reply'] : '你还没有回复呦'); ?></div>
        </div>
        <div class="form-group">
...
<script type="text/javascript">
    $('#Reply-one').click(function () {
        $.ajax({
            url:'<?php echo e(route('merchant.orders.guestBook',['gid'=>$content[0]['id']])); ?>',
            type:'post',
            data:$('form').serialize(),
            dataType:'json',
