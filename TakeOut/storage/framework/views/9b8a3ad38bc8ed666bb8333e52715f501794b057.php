...
<?php $__env->startSection('name'); ?>
	<dl class="collapsible_menu">
		<dt>
			<span><?php echo e(session('smid')); ?></span> 
	                ...
	                <div class="c_detail">
	                	<div style="background-color:#fff;" class="c_logo">
		                	<a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
		                				                			<img width="190" height="190" alt="公司logo" src="/merchant/style/images/logo_default.png">
		                ...
		                <!--  			                <div class="c_logo" style="background-color:#fff;">
			                	<div id="logoShow">
			                		<img src="/merchant/style/images/logo_default.png" width="190" height="190" alt="公司logo" />
		                        	<span>更换公司图片<br />190px*190px 小于5M</span>
		                        </div>
	                    ...
	                    <div class="c_box companyName">
	                        ...
	                        <div class="clear oneword"><img width="17" height="15" src="/merchant/style/images/quote_l.png">&nbsp; <span>测试的发打发打发大范德萨发</span> &nbsp;<img width="17" height="15" src="/merchant/style/images/quote_r.png"></div>
       				...
       				<div id="Product">
	        					...
	        					<div class="product_wrap">
					                        ...
					                        <form method="post" class="productForm">
					                            <div class="new_product">
							                            ...
							                            <div class="product_upload productShow">
							                            	<img width="380" height="220" src="/merchant/style/images/product_default.png">
					                ...
					                <dl class="c_product">
					                    ...
					                    <dd>
					                    	<img width="380" height="220" alt="发大发" src="/merchant/style/images/product_default.png">
				                        	<div class="cp_intro">
			       					...
			       					<div class="member_wrap">
			                        		...
			                        		<form class="memberForm">
					                            <div class="new_portrait">
						                            ...
						                            <div class="portraitShow">
						                            	<img width="120" height="120" src="/merchant/style/images/leader_default.png">
							                        	<span>更换头像</span>
							                        </div>
				                    	...
				                    	<div class="member_info">
				                        	...
				                        	<div class="m_portrait">
				                            	<div></div>
				                            	<img width="120" height="120" alt="孙泰英" src="/merchant/style/images/leader_default.png">
					                        </div>
				                            <div class="m_name">
				                            	孙泰英 
