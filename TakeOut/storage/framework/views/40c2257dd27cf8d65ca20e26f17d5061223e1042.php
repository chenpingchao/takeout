...
<div class="margin clearfix">
 <div class="cover_style" id="cover_style">
    ...
    <div class="search_style">
        <form action="" method="post">
            ...
            <ul class="search_content clearfix">
                <li>
                    ...
                    <input name="orders_num" value="<?php echo e($orders_num); ?>" type="text" class="text_add" placeholder="订单订单编号" style=" width:250px">
                </li>
                <li>
                    <label class="l_f">开始时间</label>
                    <input name="start_time" value="<?php echo e($start_time); ?>" autocomplete="off" class="inline laydate-icon" id="start_time" style=" margin-left:10px;">
                </li>
                <li>
                    <label class="l_f">结束时间</label>
                    <input name="end_time" value="<?php echo e($end_time); ?>"  autocomplete="off" class="inline laydate-icon" id="end_time" style=" margin-left:10px;">
                </li>
                <li>
                    <label class="l_f">状态</label>
                    <select name="active" id="active">
                        <option value="7" >全部</option>
                        <option value="1" <?php echo e($active==1 ? 'selected' : ''); ?>>未付款</option>
                        <option value="2" <?php echo e($active==2 ? 'selected' : ''); ?>>已付款</option>
                        <option value="3" <?php echo e($active==3 ? 'selected' : ''); ?>>已发货</option>
                        <option value="4" <?php echo e($active==4 ? 'selected' : ''); ?>>已签收</option>
                        <option value="5" <?php echo e($active==5 ? 'selected' : ''); ?>>已评论</option>
                        <option value="6" <?php echo e($active==6 ? 'selected' : ''); ?>>退货</option>
                    </select>
                </li>
                <li style="width:90px;">
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
             ...
             <td><?php echo e($v -> orders_menu_num); ?></td>
             <td class="td-status">
                 <?php switch($v ->active):
                     case (1): ?>
             ...
             <td>
                 <a title="订单详细"  href="<?php echo e(route("bg.orders.detail",[ 'id' => $v->id ])); ?>"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a>
                 <a title="删除" href="javascript:;" onclick="Order_form_del(this,'<?php echo e(route('bg.orders.delete',['id' => $v -> id])); ?>')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
             </td>
            </tr>
     ...
     <div class="page_div">
         <span >共<?php echo e(empty($data) ? 0 : $data -> total()); ?>条记录,当前页为第<?php echo e(empty($data) ? 1 : $data -> currentPage()); ?>页</span>

         <?php echo e(empty($data) ? '' : $data ->appends([
