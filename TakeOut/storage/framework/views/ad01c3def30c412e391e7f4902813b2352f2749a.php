			...
			<ul class="nav ace-nav">
				<li class="light-blue">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle">
						<span  class=""><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>超级管理员</span>
					...
					<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li><a href="<?php echo e(route('bg.admin.info')); ?>" target="iframe" name="admin_info.html" title="个人信息" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
						<li class="divider"></li>
	...
	<div class="main-container-inner">
		...
		<!-- #sidebar-shortcuts -->
			<div id="menu_style" class="menu_style">
				...
				<iframe src="<?php echo e(route('bg.left')); ?>" name="left" frameborder="0" width="189" height="100%" scrolling="no"></iframe>
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					<li>
						...
						<a href="<?php echo e(route('bg.index')); ?>">首页</a>
					</li>
			...
			<iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="<?php echo e(route("bg.main")); ?>">  </iframe>
			<!-- /.page-content -->
		</div><!-- /.main-content -->
...
<iframe id="bottom" src="<?php echo e(route('bg.footer')); ?>" name="footer" frameborder="0" width="100%" height="31" scrolling="no"></iframe>
...
<script>
	//退出
	function logout(){
		layer.confirm('真的要退出吗?' , {title:'退出提示' , icon:3 , 'btn':['确认','取消'] }, function(){
			//异步提交退出请求
			$.get("<?php echo e(route('bg.Logout')); ?>","",function(data){
				if(data.status == 'ok'){
