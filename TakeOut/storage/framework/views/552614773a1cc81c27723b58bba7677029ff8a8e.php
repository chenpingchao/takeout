    ...
    <div class="article_style" id="article_style">
        ...
        <div class="Ads_list" style="margin-left:0px; ">
            ...
            <div class="border clearfix"><span class="l_f"><a href="<?php echo e(route('bg.shop.deletes')); ?>" class="btn shop-deletes"><i class="fa fa-trash"></i> 批量删除</a></span>
                <span class="r_f">共：<b><?php echo e($shop_list_num); ?></b>家</span>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php switch($v -> active):
                                case (1): ?>
                            <a href="<?php echo e(route('bg.shop.active1',['id'=>$v->id,'active'=>$v -> active])); ?>" class="shop-active1">
                                工作中</a>
                            <?php break; ?>
                                <?php case (2): ?>
                            <a href="<?php echo e(route('bg.shop.active1',['id'=>$v->id,'active'=>$v -> active])); ?>" class="shop-active1">
                        ...
                        <td class="td-manage">
                            <a title="禁用" href="<?php echo e(route('bg.shop.stop',['id'=>$v->id,'active'=>$v->active])); ?>" class="btn btn-xs shop-stop btn-success" ><i class="fa fa-check  bigger-120"></i></a>
