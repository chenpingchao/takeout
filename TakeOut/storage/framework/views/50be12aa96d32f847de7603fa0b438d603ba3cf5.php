				...
				<div class="c_detail">
					...
					<div class="c_box companyName">
						...
						<form class="clear editDetail dn" id="editDetailForm" method="post" action="<?php echo e(route('merchant.shop.shopchange')); ?>">
							...
							<input type="text" placeholder="店铺地址" value="<?php echo e($detail -> site); ?>" name="site" id="companyFeatures">
						...
						<div class="clear oneword">
							<h1 title="详细名称" class="fullname"><?php echo e($detail -> shop_name); ?></h1>
							...
							<img width="17" height="15" src="/merchant/style/images/quote_l.png">&nbsp;
							<span><?php echo e(mb_substr($detail -> detail,0,26)); ?></span> &nbsp;
							<img width="17" height="15" src="/merchant/style/images/quote_r.png"></div>
					</div>
