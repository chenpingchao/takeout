...
<body>
<?php echo e($errors -> first('cate_name')); ?>
...
<ul>
    <form action="" method="post">
        ...
        <li>
            ...
            <input type="text" id="parent_name" name="parent_name" disabled value="<?php echo e(isset($parentName) ? $parentName : '顶级分类'); ?>" style="line-height: 2em;text-indent: 5px">
        </li>
        <li>
            <label for="cate_name">&emsp;&emsp;分类名称:</label>
            <input type="text" id="cate_name" name="cate_name" style="line-height: 2em"><span class="errors"><?php echo e($errors -> first('cate_name')); ?></span>
        </li>
        <li>
