...
<section class="Shop-index">
 <article>
  <div class="shopinfor">
   <div class="title">
    ...
    <span><?php echo e($shop_msg->grade); ?></span>
   </div>
   <div class="imginfor">
    <div class="shopimg">
    ...
    <div class="shoptext">
     <p><span>地址：</span><?php echo e($shop_msg->site); ?></p>
     <p><span>电话：</span><?php echo e($shop_msg -> shop_mobile); ?></p>
     <p><span>特色菜品：</span>毛肚、牛丸、滑虾、羊肉、香辣虾...</p>
     <p><span>优惠活动：</span>暂无信息</p>
     <p><span>停车位：</span>4个停车位（免费）</p>
     <p><span>营业时间：</span>09:00~22:00</p>
     <p><span>价格：</span><?php echo e($shop_msg-> avg_price); ?>元</p>
     <div class="Button">
      <a href="#ydwm"><span class="DCbutton">查看菜谱点菜</span></a>
     </div>
     <div class="otherinfor">

     <a href="<?php echo e(route('home.shop_Collection',['sid'=>$sid])); ?>" id="collection-add-del" class="icoa">
         <img src="/home/images/collect.png">
         收藏店铺（<?php echo e($Collection); ?>）
     </a>
  ...
  <div class="title2 cf">
    <ul class="title-list fr cf ">
      ...
      <li onclick="comment(1,'<?php echo e(route('home.shopDetail',['sid'=>$shop_msg->id])); ?>')">累计评论（<?php echo e($menu_comment_num); ?>）</li>

      <li>商家详情</li>

      <li onclick="guestbook(1,'<?php echo e(route('home.shopDetail',['sid'=>$shop_msg->id])); ?>')">店铺留言</li>
      <p><b></b></p>
    </ul>
  </div>
   ...
   <a name="ydwm"></a>
    ...
    <div id="menutabs2" style="display: none" class="current menutab">
     ...
     <div class="shopdetailsT">
      <p><span>店铺：<?php echo e($shop_msg -> shop_name); ?></span></p>
      <p><span>地址：</span><?php echo e($shop_msg -> site); ?></p>
      <p><span>电话：</span><?php echo e($shop_msg -> shop_mobile); ?></p>
      <p><span>乘车路线：</span>300路、115路、14路、800路到西辛庄站下车往东100米</p>
      <p><span>店铺介绍：</span><?php echo e($shop_msg ->detail); ?></p>
     </div>
    </div>
    </div>
    <!--case3-->
 ...
 <aside>
  <div class="cart" id="Topcart">
	<span class="Ctitle Block FontW Font14"><a href="<?php echo e(route("home.cart")); ?>" target="_blank">我的购物车</a></span>
	...
	<p class="Ptc"><span class="Cbutton"><a href="<?php echo e(route('home.cart')); ?>" target="进入购物车">进入购物车</a></span><span class="total">共计金额: ￥0</span></p>
  </div>
 ...
 <script>
   ...
   $('#guestbook_add').click(function(){
       if ('<?php echo e(session('mid')); ?>'){
           $.post('<?php echo e(route('home.guestbook',['sid'=>$shop_msg->id])); ?>', $('#form_adds').serialize(), function (data) {
               //判断是否登录成功
               if (data.status === 'ok') {
                   layer.msg(data.msg, {time: 1000},function () {
                       location = '<?php echo e(route("home.shopDetail",['sid'=>$sid])); ?>';
                   });
               } else {
                   layer.msg(data.msg,{time: 1000,},function () {
                       location = '<?php echo e(route("home.shopDetail",['sid'=>$sid])); ?>';
