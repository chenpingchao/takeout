...
<div class="page-content clearfix">
    <div class="sort_adsadd_style">
        <div class="search_style">
            <!-- 搜索 -->
            <form action="<?php echo e(route('bg.advertis.index')); ?>" style="height: 50px">
                <ul class="search_content clearfix" style=>
                    <li>
                        <label class="l_f">广告位名称</label>
                        <input name="advertisp_name" type="text" value="<?php echo e(old('advertisp_name')); ?>" class="text_add" placeholder="输入广告位名称"  style=" width:150px"/>
                    </li>
                    <li>
            ...
            <span class="l_f">
                <a href="<?php echo e(route('bg.advertis.add')); ?>"  id="ads_add" title="添加品牌" class="btn advertisP-add btn-warning Order_form"><i class="fa fa-plus"></i> 添加广告位</a>
                <a href="<?php echo e(route('bg.advertis.deletes')); ?>" class="btn advertisP-deletes btn-danger"><i class="fa fa-trash"></i> 批量删除</a>
                <a href="javascript:ovid()" onClick="javascript :history.back(-1);" class="btn btn-info"><i class="fa fa-reply"></i> 返回上一步</a>
            </span>
            <span class="r_f">共：<b><?php echo e($advertis_index_num); ?></b>个广告位</span>
            </div>
        </div>
            <!--列表样式-->
        <div class="sort_Ads_list">
            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <td><?php echo e($k+$advertis_index->firstItem()); ?></td>
                    <td><?php echo e($v->advertisP_name); ?></td>
                    <td><?php echo e($v->id); ?></td>
                    <td><?php echo e($v->height); ?></td>
                    <td><?php echo e($v->width); ?></td>
                    <td><a><?php echo e($v->description); ?></a></td>
                    <td><?php echo e(date('Y-m-d H:i:s',$v -> add_time)); ?></td>
                    <td class="td-status">
                        <a href="<?php echo e(route('bg.advertis.active',['id'=>$v->id,'active'=>$v->active])); ?>" class="advertis_active">
                            <?php echo e($v->active == 1 ? '显示':'不显示'); ?>

                        </a>
                    </td>
                    <td class="td-manage">
                        <a href="<?php echo e(route('bg.advertis.details',['id'=>$v->id])); ?>" title="详情" class="btn btn-xs btn-success"><i class="fa fa-check bigger-120"></i></a>
                        <a href="<?php echo e(route('bg.advertis.edit',['id'=>$v->id])); ?>" title="编辑" class="btn btn-xs advertisP-edit btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                        <a href="<?php echo e(route('bg.advertis.delete',['id'=>$v->id])); ?>" title="删除" class="btn advertisP-delete btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                    </td>
                </tr>
            ...
            <div class="page_div">
                <div class="message">共<i class="blue"><?php echo e($advertis_index->total()); ?></i>条记录，当前显示第&nbsp;<i class="blue"><?php echo e($advertis_index->currentPage()); ?>&nbsp;</i>页</div>
                <?php echo e($advertis_index->links()); ?>
