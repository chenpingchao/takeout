        ...
        <form action="">
            <ul class="search_content clearfix">
                <li>
                    ...
                    <input name="menu_name" type="text" value="<?php echo e(old('menu_name')); ?>" class="text_add" placeholder="输入分类名称"  style=" width:150px"/>
                </li>
                <li>
                    <label class="l_f">关键字</label>
                    <input name="key_words" type="text" value="<?php echo e(old('key_words')); ?>" class="text_add" placeholder="输入搜索关键字"  style=" width:150px"/>
                </li>
                <li>
                    <label class="l_f">店铺名称</label>
                    <input name="shop_name" type="text" value="<?php echo e(old('shop_name')); ?>" class="text_add" placeholder="输入店铺名称"  style=" width:150px"/>
                </li>
                <li>
                ...
                <li>
                    <span class="r_f">共：<b><?php echo e($data['menu_num']); ?></b>&ensp;件商品</span>
                </li>
            </ul>
        ...
        <tbody id="tbody">
            <form action="" id="form1">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                 <tr>
                    <td width="25px"><label><input type="checkbox" class="ace" name="chk[]"value="<?php echo e($v -> id); ?>"><span class="lbl"></span></label></td>
                    <td width="80px"><?php echo e($v -> id); ?></td>
                    <td width="250px">
                        <a href="javascript:detail('<?php echo e($v -> id); ?>');" class="text-primary"><?php echo e($v -> menu_name); ?></a>
                    </td>
                     <td width="100px"><?php echo e($v -> shop_name); ?></td>
                     <td width="50px"><a href="<?php echo e(route('admin.menu.salde',['id' => $v -> id])); ?>" class="salde"><?php echo e($v -> salde_num); ?></a></td>
                     <td width="50px"><?php echo e($v -> eval_num); ?></td>
                    <td width="100px"><?php echo e($v -> or_price); ?></td>
                    <td width="100px"><?php echo e($v -> price); ?></td>
                    <td width="180px"><?php echo e(date( "Y-m-d H:i:s", $v -> add_time )); ?></td>
                    <td class="td-status">
                         <a href="<?php echo e(route('admin.menu.active',['id'=>$v->id , 'active'=>$v->active])); ?>" class="active_change" >
                             <span class="label <?php echo e($v -> active == 1 ? 'label-success' : 'label-defaunt'); ?>  radius<?php echo e($v->id); ?>"><?php echo e($v -> active == 1 ? '激活' : '停用'); ?></span>
                         </a>
                    </td>
                    <td class="td-manage">
                        <a title="编辑" href="<?php echo e(route('admin.menu.edit',['id' => $v -> id])); ?>"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a>
                        <a title="删除" href="<?php echo e(route('admin.menu.delete',['id' => $v -> id])); ?>" class="btn btn-xs btn-warning delete" ><i class="icon-trash  bigger-120"></i></a>
                   </td>
                  </tr>
                ...
                <tr>
                    ...
                    <td colspan="10" style="text-align: left"><a href="<?php echo e(route('admin.menu.delete',['id' => 0])); ?>" class="delAll">批量删除</a></td>
                </tr>
            </form>
        </tbody>
    </table>
             <div style="float: right"><?php echo e($menu -> appends(['menu_name' => $menu_name,'active' => $active]) -> links()); ?></div>
    </div>
  </div>
 </div>
</div>
...
function detail(id){
    parent.layer.open({
        ...
        title:'商品图片',
        area:['600px','600px'],
        content:'<?php echo e(route('admin.menu.image')); ?>?id='+id
    })
}
