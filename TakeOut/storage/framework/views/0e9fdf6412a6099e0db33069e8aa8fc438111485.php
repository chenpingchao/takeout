...
<div class="page-content clearfix">
    <div class="alert alert-block alert-success"><?php echo session('aname')?>
        <button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button>
        <i class="icon-ok green"></i>欢迎使用<strong class="green">后台管理系统<small>(v1.2)</small></strong>,你本次登陆时间为<?php echo date('Y年m月d日 H时i分s秒',$Admin[0]['login_time'])?>，登陆IP:<?php echo $Admin[0]['login_ip'];?>,已登录<?php echo $Admin[0]['login_num'];?>次.
    </div>
    ...
    <div class="clearfix">
        <div class="home_btn">
            <div>
                <a href="<?php echo e(route('admin.menu.add')); ?>"  title="添加商品" class="btn  btn-info btn-sm no-radius">
                    <i class="bigger-200"><img src="/admin/images/icon-addp.png" /></i>
                    <h5 class="margin-top">添加商品</h5>
                </a>
                <a href="<?php echo e(route('admin.category.list')); ?>"  title="产品分类" class="btn  btn-primary btn-sm no-radius">
                    <i class="bigger-200"><img src="/admin/images/icon-cpgl.png" /></i>
                    <h5 class="margin-top">产品分类</h5>
                </a>
                <a href="<?php echo e(route('bg.admin.info',['id'=>session('aid')])); ?>"  title="个人信息" class="btn  btn-success btn-sm no-radius">
                ...
                <a href="<?php echo e(route("bg.orders.order")); ?>"  title="商品订单" class="btn  btn-purple btn-sm no-radius">
                    <i class="bigger-200"><img src="/admin/images/icon-gwcc.png" /></i>
                    <h5 class="margin-top">商品订单</h5>
                </a>
                <a href="<?php echo e(route('bg.advertis.index')); ?>"  title="广告管理" class="btn  btn-pink btn-sm no-radius">
                    <i class="bigger-200"><img src="/admin/images/icon-ad.png" /></i>
                    <h5 class="margin-top">广告管理</h5>
                </a>
                <a href="<?php echo e(route('bg.article.add')); ?>"  title="添加文章" class="btn  btn-info btn-sm no-radius">
