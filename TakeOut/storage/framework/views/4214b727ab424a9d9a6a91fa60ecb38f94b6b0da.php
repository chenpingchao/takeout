        ...
        <div class="d_Confirm_Order_style">
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $shop_member; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($v -> id); ?></td>
                            <td><?php echo e($v -> shop_member_name); ?></td>
                            <td><?php echo e($v -> mobile); ?></td>
                            <td><?php echo e(date('Y-m-d H:i:s',$v -> add_time)); ?></td>
                            <td><a  class='shop-member-active2' href="<?php echo e(route('bg.shop.member.active2',['id'=>$v->id,'active'=>$v->active])); ?>"><?php echo e($v -> active == 1? '激活' : '禁用'); ?></a></td>
                        </tr>
                ...
                <div>共&nbsp;<?php echo e($shop_member->total()); ?>&nbsp;条数据 当前第&nbsp;<?php echo e($shop_member->currentPage()); ?>&nbsp;页</div>
                <div style="float: right"><?php echo e($shop_member -> appends(['shop_member_name'=>$shop_member_name,'active'=>$active]) -> links()); ?></div>
            </div>
        </div>
    </div>
</div>
