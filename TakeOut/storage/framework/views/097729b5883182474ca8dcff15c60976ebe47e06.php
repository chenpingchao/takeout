	...
	<div class="login_wrapper">
		...
		<div class="login_box">
            ...
            <div class="login_right">
            	<div>已有拉勾帐号</div>
            	<a  href="<?php echo e(route('merchant.login')); ?>"  class="registor_now">直接登录</a>
         ...
         $("#loginForm").validate({
            ...
            rules: {
                shop_member_name: {
                    required: true,
                    remote:{
                        url:'<?php echo e(route('merchant.remoteShopMemberName')); ?>',
                        type:'post',
                ...
                mobile :{
                    ...
                    mobile:true,
                    remote:{
                        url:'<?php echo e(route('merchant.remoteMobile')); ?>',
                        type:'post',
                        data:{_token:'<?php echo e(csrf_token()); ?>'}
                    }
                },
                Auth_code: {
                    required: true,
                    remote:{
                        url:'<?php echo e(route('merchant.remoteMobileCode')); ?>',
                        type:'post',
                        data:{_token:'<?php echo e(csrf_token()); ?>'}
                    }
                },
...
//短信验证码
    function get_mobile_code(){
        $.post('<?php echo e(route('merchant.mobile')); ?>', {_token:'<?php echo e(csrf_token()); ?>',mobile:jQuery.trim($('#mobile').val())}, function(msg) {
            if(msg ==='提交成功'){
                RemainTime();
            }else{
                //	location.reload();
