    ...
    <div class="Receiver_style">
     ...
     <div class="Info_style clearfix">
        <div class="col-xs-3">
         ...
         <div class="o_content"><?php echo e($orders_msg[0] -> name); ?></div>
        </div>
        <div class="col-xs-3">
         <label class="label_name" for="form-field-2"> 收件人电话： </label>
         <div class="o_content"><?php echo e($orders_msg[0] -> moble); ?></div>
        </div>
...
<div class="Button_operation">
				<button  class="back_page btn btn-primary radius" type="submit"><i class="icon-save "></i>返回上一步</button>
...
<script>
    ...
    function layer_close(){
        location = "<?php echo e(route('bg.orders.order')); ?>";
    }
