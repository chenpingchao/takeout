...
<div class="page-content clearfix">
    ...
    <!--操作-->
     <div class="border clearfix">
       <span class="l_f">
        ...
        <a href="<?php echo e(route('bg.admin.deletes')); ?>" class="admin-deletes btn btn-danger"><i class="fa fa-trash"></i> 批量删除</a>
       </span>
        ...
        <div class="widget-box side_content" >
         ...
         <div class="widget-body">
           ...
           <li><i class="fa fa-users green"></i> <a href="#">全部管理员（13）</a></li>
            ...
            <li><i class="fa fa-users orange"></i> <a href="#">栏目主编（4）</a></li>
            <li><i class="fa fa-users orange"></i> <a href="#">栏目编辑（1）</a></li>
           </ul>
        </div>
       </div>
      </div>  
      ...
      <div class="table_menu_list"  id="testIframe">
          <form action="">
           ...
           <table class="table table-striped table-bordered table-hover" id="sample_table">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tbody>
                    <tr>
                        <td><label><input name="chk[]" class="ace" type="checkbox" value="<?php echo e($v->id); ?>" /><span class="lbl"></span></label></td>
                        <td><?php echo e($k+1); ?></td>
                        <td><?php echo e($v->username); ?></td>
                        <td><?php echo e($v->moble?$v->moble:'|ू･ω･`)'); ?></td>
                        <td><?php echo e($v->email?$v->email:'〒▽〒'); ?></td>
                        <td>
                            <?php
                            //{{$v->grade}}
                        ...
                        <td><?php echo e($v->add_time?date('Y-m-d H:i:s',$v->add_time):'开天之物'); ?></td>
                        <td class="td-status">
                            <span class="label label-success radius">
                                <a href="<?php echo e(route('bg.admin.active',['id'=>$v->id,'active'=>$v->active])); ?>" class="admin-active tablelink">
                                <?php echo e($v->active==1 ? '激活' : '禁用'); ?></a>
                            </span>
                        </td>
                        <td class="td-manage">
                            <a title="编辑" href="<?php echo e(route('bg.admin.info',['id'=>$v->id])); ?>"  onclick="member_edit('编辑','member-add.html','4','','510')"   class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                            <a title="删除" href="<?php echo e(route('bg.admin.delete',['id'=>$v->id])); ?>"  onclick="member_del(this,'1')" class="admin-delete btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                        </td>
                    </tr>
                </tbody>
 ...
 <!--添加管理员-->
     <div id="add_administrator_style" class="add_menber" style="display:none">
        <form action="<?php echo e(route('bg.admin.add')); ?>" method="post" id="form-admin-add">
            <?php echo e(csrf_field()); ?>
...
if('<?php echo e(session('status')); ?>' === 'ok'){
    //添加成功
    layer.confirm('<?php echo e(session('msg')); ?>' , {icon:3,title:'跳转提示',btn:['继续添加','去管理员列表']},
        function(){
            //继续添加
        ...
        function(){
            //去管理员列表
            location = '<?php echo e(session('url')); ?>';
        }
    )
}else if('<?php echo e(session('status')); ?>' === 'error'){
    layer.msg('<?php echo e(session('msg')); ?>' , {icon:6,shade:[0.6]},
        function(){
            //去管理员列表
            location = '<?php echo e(session('url')); ?>';
        }
