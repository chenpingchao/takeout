    ...
    <form action="" method="post">
        ...
        <li>
            ...
            <select name="pid" id="parent_name" style="height:32px;line-height: 2em;text-indent:5px;display: inline-block" >
                    <option  value="0" <?php echo e($category -> pid == 0 ? 'selected' : ''); ?>>顶级分类</option>
                <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($v -> id); ?>" <?php echo e($v -> id == $category -> pid ? 'selected' : ''); ?>><?php echo e($v -> cate_name); ?></option>
        ...
        <li>
            ...
            <span class="errors errors-cate_name"><?php echo e($errors -> first('cate_name')); ?></span>
        </li>
        <li>
