		...
		<div class="left_Competence_add">
			...
			<div class="Competence_add">
				...
				<div class="Button_operation">
					...
					<a href="<?php echo e(route('bg.admin.Power')); ?>" class="btn btn-secondary  btn-warning" type="button">返回上一步</a>
					...
					<dd>
						<dl class="cl permission-list2">
							...
							<dd>
								...
								<label class="middle">
									<input type="checkbox" value="" class="ace" name="user-Character-0-0-0" id="user-Character-0-0-3">
									<span class="lbl">查看</span>
								</label>
								<label class="middle">
									<input type="checkbox" value="" class="ace" name="user-Character-0-0-0" id="user-Character-0-0-4">
						...
						<dl class="cl permission-list2">
							<dt>
								<label class="middle">
									<input type="checkbox" value="" class="ace"  name="user-Character-0-1" id="user-Character-0-1">
