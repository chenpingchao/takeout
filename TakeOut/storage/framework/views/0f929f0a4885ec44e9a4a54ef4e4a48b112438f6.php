...
<!--如果用户未添加收货地址，则显示如下-->
 <div class="confirm_addr_f">
  ...
  <!--已保存的地址列表-->
   ...
   <ul class="address">
     <?php $__empty_1 = true; $__currentLoopData = $member_msg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k =>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <li id="style<?php echo e($k+1); ?>">
          <input type="radio" value="" <?php echo e($v->active ==1?'checked':''); ?> id="<?php echo e($v->id); ?>" name="rdColor" onclick="changeColor('<?php echo e($k+1); ?>',this)"/>
          <label for="1"> <?php echo e($v->location); ?>&emsp;<?php echo e($v -> site); ?>（<?php echo e($v->name); ?>）
            <span class="fontcolor"><?php echo e($v -> mobile); ?></span>
          </label>
        </li>
    ...
    <form action="<?php echo e(route('hm.mem.UserAddress_add')); ?>" method="post" id="add_site">
  ...
  <div class="inforlist">
   ...
   <table>
    ...
    <tr class="tr">
      ...
      <td><?php echo e($v -> buynum); ?></td>
      <td>￥<i><?php echo e($v -> price); ?></i></td>
      <td>￥<i>118</i></td>
     </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   </table>

   <form action="<?php echo e(route('home.orderCreate')); ?>" method='post' id="form1">
    <?php echo e(csrf_field()); ?>
    ...
    <input type="hidden" name="siteId" id="siteId" value="">
      ...
      <div class="Order_M">
       ...
       <select name="redpacket" id="redpacket">
           ...
           <?php $__empty_1 = true; $__currentLoopData = $redpacket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
               <option value="<?php echo e($v -> id); ?>" num="<?php echo e($v->value); ?>" <?php echo e($v->type ==1? '':($orders_price >= $v->value*3 ? '':'disabled')); ?>>￥<?php echo e($v->value); ?>元<?php echo e($v->type==1?'无门槛':'满'.$v->value*3); ?>优惠券</option>
           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
      ...
      <div class="Sum_infor">
      <p class="p1">配送费用：￥<i id="pei">0.00</i>+商品费用：￥<i id="fei"><?php echo e($orders_price); ?></i>-优惠券：￥<i id="you">0.00</i></p>
