									...
									<ul>
									   ...
									   <li class="frame_style form_error">
										   ...
										   <div class="Codes_region">
											   <img src="<?php echo e(route("bg.captcha")); ?>" alt="验证码" onclick="this.src='<?php echo e(route("bg.captcha")); ?>?num='+Math.random()">
										   </div>
									   </li>
									</ul>
										<div class="space"></div>
...
<script>
	...
	$('#login_btn').click(function(){
		//执行异步请求
		$.post("<?php echo e(route('bg')); ?>",$('form').serialize(),function(data){
			// console.log(data);
			if( data.status == 'ok' ){
