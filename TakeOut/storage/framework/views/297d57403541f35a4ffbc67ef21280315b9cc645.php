...
<nav class="U-nav Font14 FontW">
 ...
 <article class="U-article Overflow">
  ...
  <section class="AccManage Overflow">
   ...
   <p>登陆邮箱：<?php echo e($member->email); ?> ( <a href="#" id="email" target="_blank">更换邮箱</a> )</p>
   <p>手机号码：<?php echo e($member->mobile); ?> ( <a href="#" id="mobile" target="_blank">更换手机号码</a> )</p>
   <p>上次登陆：<?php echo e(date('Y年m月d日 H时i分s秒',$member->old_login)); ?>( *如非本人登陆，请立即<a href="#" id="pass" target="_blank">修改您的密码</a>！ )</p>
   ...
   <form action="" method="post" enctype="multipart/form-data" id="member-form">
    ...
    <td>
     <div class="preview-div1" style="position:relative">
      ...
      <img  src="/<?php echo e($member->avatar_dir); ?><?php echo e($member->avatar); ?>"  alt="" width="200px" height="150px" style="position:absolute;left:500px;top:0;border-radius:50%;">
     </div>
    </td>
    </tr>
    ...
    <td>
     <input type="text" name="username" value="<?php echo e($member->username); ?>"><div class="validate-error username"></div>
    </td>
    </tr>
...
<script type="text/javascript">
   ...
   success:function(data){
    if(data.status === 'ok'){
     parent.layer.msg(data.msg,{icon:6,shade:[0.6],time:1500},function(){
      location = '<?php echo e(route("hm.mem.UserAccount")); ?>';
     })
    }else{
 ...
 <script>
  ...
  $('#email').click(function(){
   layer.open({
    ...
    area: ['500px', '420px'],
    content:['<?php echo e(route('hm.mem.UserAccount_email')); ?>','no'] //no表示不出现滚动条
   });
   return false;
  });
  //--手机
 $('#mobile').click(function () {
  layer.open({
   ...
   skin:'layui-layer-rim',
   area:['500px', '420px'],
   content:['<?php echo e(route('hm.mem.UserAccount_mobile')); ?>','no']
  });
  return false;
 });
 //--密码修改
  $('#pass').click(function () {
   layer.open({
    ...
    skin:'layui-layer-rim',
    area:['500px', '340px'],
    content:['<?php echo e(route('hm.mem.UserAccount_pass')); ?>','no']
   });
   return false
  });
 </script>
