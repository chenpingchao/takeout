    ...
    <div class="add_box">
        ...
        <div class='detail' style="height: 50px">
            <div id="buttom">
                ...
                <?php if($menu_cate -> active ==1): ?>
                    <input type="button" href="<?php echo e(route('merchant.shop.menuCateActive',["mc_id"=>$menu_cate->id,"active"=>$menu_cate->active])); ?>" id="active" style="background:#0F0;"  class="buttom" value="激活">
                <?php else: ?>
                    <input type="button" href="<?php echo e(route('merchant.shop.menuCateActive',["mc_id"=>$menu_cate->id,"active"=>$menu_cate->active])); ?>" id="active"  style="background:#f00;color:#fff;"  class="buttom" value="禁用">
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class='add_box'>
        ...
        <dl>
            <dd >
                ...
                <input type="text" name="name" class="add-tuan-input" id="tg_name" placeholder="请输入团购大礼包的名称" value="<?php echo e($tuan -> name); ?>">
                <div class="image name"></div>
            </dd>
            <dd >
                <label for="num">成团人数：</label>
                <input type="text" name="num" class="add-tuan-input" id="num" placeholder="请合理填写人数，以免造成损失" value="<?php echo e($tuan -> num); ?>">
            ...
            <dd>
                ...
                <input type="text" name="price"  class="add-tuan-input" id="price" placeholder="请填写团购礼包的价格"  value="<?php echo e($tuan -> price); ?>">
...
<script>
    ...
    $('#delete').click(function(){
        $.get('<?php echo e(route('merchant.shop.deleteMenuCate',['mc_id'=> $menu_cate->id])); ?>','',function(data){
            if(data.status == 'ok'){
                // alert('a');
                parent.location.reload();
