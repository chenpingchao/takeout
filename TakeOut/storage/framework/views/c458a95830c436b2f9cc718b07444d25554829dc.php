...
<?php $__env->startSection('name'); ?>
	<ul class="loginTop">
		<li><a href=""><?php echo e(session('smname')); ?></a></li>
	</ul>
<?php $__env->stopSection(); ?>
        	...
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                <form id="stepForm"  method="post" enctype="multipart/form-data">
	                	<input type="hidden" name='uid' value='<?php echo e($detail -> id); ?>'>
	                	<input type="hidden" name='sid' value='<?php echo e($detail -> sid); ?>'>
						...
						<div class="c_logo c_logo_pos">
							<div class="preview-div">
								...
								<input type="file" id="pic" value="/<?php echo e($detail -> image_dir.$detail -> image); ?>" name="image" onchange="preview(this,200,200)" class="preview-input">
								<img src="/<?php echo e($detail -> image_dir.$detail -> image); ?>" alt="" >
							</div>
						</div>

	                    <h3>菜品名称 </h3>
	                    <input type="text" placeholder="请输入菜品名称" value="<?php echo e($detail->menu_name); ?>" name="menu_name" id="menu_name" class="valid">
						<div class="image shop_name"></div>

						<h3>菜品关键词</h3>
						<input type="text" placeholder="请输入菜品关键词" value="<?php echo e($detail->key_words); ?>" name="key_words" id="key_words">
	                    ...
	                    <h3>菜品分类</h3> <!--非必填改必填-->
							<div style="float:left;margin-bottom:10px;">
								...
								<select  name="thirdCate" style="width: 225px;opacity:100">
									<option value="<?php echo e($detail-> cid); ?>" ><?php echo e($cate[0]-> cate_name); ?></option>
								</select>
								<div class="validate-error thirdCate" style="left:0;background: url('/image/error.png') no-repeat 5px 10px;"></div>
							</div>

						<h3>菜品原价</h3>
						<input type="text" placeholder="请输入菜品原价" value="<?php echo e($detail -> or_price); ?>" name="or_price" id="or_price">
						<div class="image website"></div>

						<h3>菜品现价</h3>
						<input type="text" placeholder="请输入菜品现价" value="<?php echo e($detail -> price); ?>" name="price" id="price">
						<div class="image shop_mobile"></div>

	                    <h3>菜品介绍</h3>
						<textarea  name="detail" id="temptation"  cols="30" rows="10"><?php echo e($detail -> detai); ?></textarea>
